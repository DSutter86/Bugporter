...
namespace Bugporter.API
{
    public class Startup : FunctionsStartup
    {
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            {
                o.Owner = builder.GetContext().Configuration.GetValue<string>("GITHUB_REPOSITORY_OWNER");
                o.Name = builder.GetContext().Configuration.GetValue<string>("GITHUB_REPOSITORY_NAME");
            });
